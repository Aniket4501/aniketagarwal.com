...
export function Footer() {
  return (
    <footer className="border-t border-[var(--color-rule)]">
      <Container className="flex flex-col gap-5 py-7 lg:flex-row lg:items-end lg:justify-between lg:py-10">
        ...
        <ul className="flex flex-wrap items-center gap-x-3 gap-y-1.5 font-[family-name:var(--font-mono)] text-[var(--text-sm)]">
          <li>
            <a
              href={site.linkedin}
              rel="me noopener"
      ...
      <Container className="border-t border-[var(--color-rule)] py-3">
